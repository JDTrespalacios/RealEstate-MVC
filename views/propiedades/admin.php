        ...
        <tbody> <!-- Mostrar los resultados-->
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/propiedades/actualizar?id=<?php echo $propiedad->id; ?>" class="boton-amarillo-block">Update</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
        ...
        <tbody> <!-- Mostrar los resultados-->
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="vendedores/actualizar?id=<?php echo $vendedor->id; ?>" class="boton-amarillo-block">Update</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
